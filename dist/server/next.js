...
__export(next_exports, {
  createNextDevNotesHandler: () => createNextDevNotesHandler,
...
function createDevNotesServerHandler(options) {
  ...
  return async function handleDevNotesRequest(request) {
    ...
    const rawProjectName = typeof options.forge.projectName === "function" ? options.forge.projectName(request) : options.forge.projectName;
    const forgeContext = {
      baseUrl,
